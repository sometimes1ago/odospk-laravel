...
<body class="w-full flex flex-col items-center relative bg-light-500 text-black-900 leading-none dark:bg-dark-900 dark:text-light-900">
  <header id="head" class="w-full">
      <div class="menu__button">
        <span class="menu__lines menu__lines-active"></span>
        <p class="menu__name">Меню</p>
      </div>
      <div class="menu menu__active">
        <ul class="menu__content">
          ...
          <li class="menu__content-col menu__help">
            <h2 class="menu__content-header">Нужна наша помощь?</h2>
            ...
            <form action="/help-request" class="menu__help-form" method="POST">
              ...
              <input class="w-full mt-32 text-14 text-light-400 bg-brand-900 py-[17px] rounded-8 cursor-pointer" type="submit" name="sendHelpRequest" value="Позвоните мне">
            </form>
          </li>
        </ul>
      </div>
