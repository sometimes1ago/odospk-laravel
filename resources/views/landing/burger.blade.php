  ...
  <ul class="menu__content">
    <li class="menu__content-col menu__nav">
      ...
      <ul class="menu__list-links">
        ...
        <li class="menu__link-item">
          <a href="#cources" class="menu__link">
    ...
    <li class="menu__content-col menu__map">
      ...
      <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Aaffdf134588f4f17bc68ba6e62806797ee2d56eb6d5e20b04c5d759c750403c8&amp;source=constructor" width="578" height="289" loading="lazy" frameborder="1" class="menu__map-frame"></iframe>
      ...
      <form action="/help-request" class="menu__help-form" method="POST">
        <ul class="menu__help-inputs">
          <li>
            ...
            <input type="text" name="customerName" id="customerName" class="menu__help-input border border-light-900 focus:outline-2 focus:outline-brand-900" placeholder="Иван Иванов" required>
          </li>
          <li class="menu__help-item">
            <label for="customerPhone" class="menu__help-label">Ваш телефон</label>
            <input type="tel" name="customerPhone" id="customerPhone" class="menu__help-input border border-light-900 focus:outline-2 focus:outline-brand-900" placeholder="+7 923 900 90 90" required>
          </li>
        </ul>
        <div class="menu__help-checkbox">
          <input type="checkbox" name="remember-me" id="remember-me" class="shrink-0 form-checkbox w-[18px] h-[18px] border-black-900 border-2" checked required>
          <label for="remember-me" class="text-14 ml-8 text-black-900 shrink-1 leading-tight">Я согласен(а) на обработку моих личных данных</label>
        </div>
        <input class="menu__help-sender w-full mt-32 text-14 text-light-400 bg-brand-900 py-[17px] rounded-8 cursor-pointer hover:shadow-btn" type="submit" name="sendHelpRequest" value="Позвоните мне">
        <button class="menu__help-modal-start w-full mt-32 text-14 text-light-400 bg-brand-900 py-[17px] rounded-8 cursor-pointer hover:shadow-btn">Заказать звонок</button>
      </form>
    </li>
  </ul>
</div>
